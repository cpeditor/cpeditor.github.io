...
**See also** [Setup WakaTime](../../setup/\_index.zh_tw.md#setup-wakatime).
...
Use [Advanced>Network Proxy](../advanced/\_index.zh_tw.md#network-proxy) to send data to WakaTime.
